...
export default function PlatanoVerdePage() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
            ...
            <h2 className="text-lg font-bold text-green-400 truncate">
              {lote || 'NINGUNO'}
            </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8">
            ...
            <button
              ...
              onClick={subirExcel}
              disabled={loading}
              className="w-full bg-green-500 hover:bg-green-600 disabled:bg-slate-700 transition-all text-white px-6 py-4 rounded-2xl font-black"
            >
              {
                loading
                  ? 'SUBIENDO EXCEL...'
